...
# Stay close to the art's natural export size: the viewbox sets the draw
# anchor, so a tag far from the real canvas shifts the image on screen.
TAGS = {
    "petal_1.pdc":      (60, 130),
    "petal_2.pdc":      (61, 130),
    "petal_3.pdc":      (62, 130),
    "petal_fall_1.pdc": (63, 130),   # natural 60 — petals own 60..62
    "petal_fall_2.pdc": (64, 130),
    "petal_fall_3.pdc": (65, 130),
    "petal_grow_1.pdc": (50, 130),   # natural 50
    "petal_grow_2.pdc": (51, 130),
    "petal_grow_3.pdc": (52, 130),
    ...
    "bee.pdc":          (50, 50),
    "icon_cloudy.pdc":  (40, 30),    # natural
    "icon_pcloudy.pdc": (45, 40),    # natural
    "icon_clear.pdc":   (40, 40),    # natural
